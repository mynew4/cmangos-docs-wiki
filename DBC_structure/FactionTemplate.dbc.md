...
*IMPORTANT: These values are only used for the "creature_template":creature_template and "gameobject_template":gameobject_template tables.*
...
bc.      1100 //hostileMask of faction 11
...
# Look for faction B in the Enemy faction list of faction A in the table below
#* If found, then faction A is hostile to faction B and you can stop
#* If not found, then continue with the next steps
# Look up hostileMask for faction A in table below
# Look up ourMask for faction B in table below
# Do the and (&amp;) operation on the two values
...
# Look for faction B in the Friend faction list of faction A in the table below
#* If found, then faction A is friendly to faction B and you can stop
#* If not found, then continue with the next steps
# Look up friendlyMask for faction A in table below
# Look up ourMask for faction B in table below
# Do the and (&amp;) operation on the two values
