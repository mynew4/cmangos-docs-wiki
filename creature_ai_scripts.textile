...
|256|EFLAG_RANGED_MODE_ONLY|Event only occurs in ranged mode (not yet implemented)|
|512|EFLAG_MELEE_MODE_ONLY|Event only occurs in melee mode (not yet implemented)|
|1024|EFLAG_COMBAT_ACTION|Only one per cycle (not yet implemented)|
