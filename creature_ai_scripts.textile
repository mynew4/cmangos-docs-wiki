...
|10|EVENT_T_OOC_LOS|Hostile 0 Friendly 1|MaxRange|RepeatMin|RepeatMax|OOC - Expires when a (Param1) Hostile 0 / Friendly 1 unit moves within (Param2) distance to creature. Will repeat every (Param3) and (Param4)|
