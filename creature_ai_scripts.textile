...
* *11 = ACTION_T_CAST*: When activated, the creature will cast a spell specified by a spell ID on a target specified by the "Target Type":creature_ai_script#TargetType.
** Parameter 1: The spell ID to use for the cast. The value used in this field needs to be a valid spell ID.
** Parameter 2: The "target type":creature_ai_script#target-type defining who the creature should cast on. The value in this field needs to be a valid "Target Type":creature_ai_script#TargetType as specified in the reference tables below.
...
** Parameter 2: The "Target Type":creature_ai_script#TargetType defining who the summoned creature will attack. The value in this field needs to be a valid target type as specified in the reference tables below. NOTE: Using "Target Type":creature_ai_script#TargetType 0 will cause the summoned creature to not attack anyone.
...
** Parameter 2: The "Target Type":creature_ai_script#TargetType defining on whom the threat change should occur. The value in this field needs to be a valid "Target Type":creature_ai_script#TargetType as specified in the reference tables below.
...
* *15 = ACTION_T_QUEST_EVENT*: When activated, this action will satisfy the external completion requirement for the quest for the specified target defined by the "Target Type":creature_ai_script#TargetType. This action can only be used with player targets so it must be ensured that the "Target Type":creature_ai_script#TargetType will point to a player.
...
** Parameter 2: The "Target Type":creature_ai_script#TargetType defining whom the quest should be completed for. The value in this field needs to be a valid "Target Type":creature_ai_script#TargetType as specified in the reference tables below.
...
** Parameter 3: The "Target Type":creature_ai_script#TargetType defining whom the quest credit should be given to. The value in this field needs to be a valid "Target Type":creature_ai_script#TargetType as specified in the reference tables below.
...
** Parameter 3: The "Target Type":creature_ai_script#TargetType defining for whom the unit field should be changed. The value in this field needs to be a valid "Target Type":creature_ai_script#TargetType as specified in the reference tables below.
...
** Parameter 2: The "Target Type":creature_ai_script#TargetType defining for whom the flags should be changed. The value in this field needs to be a valid "Target Type":creature_ai_script#TargetType as specified in the reference tables below.
...
** Parameter 1: The "Target Type":creature_ai_script#TargetType defining for whom the unit field should be changed. The value in this field needs to be a valid "Target Type":creature_ai_script#TargetType as specified in the reference tables below.
...
** Parameter 1: The creature template ID to be summoned. The value here needs to be a valid creature template ID.
** Parameter 2: The "Target Type":creature_ai_script#TargetType defining who the summoned creature will attack. The value in this field needs to be a valid "Target Type":creature_ai_script#TargetType as specified in the reference tables below. NOTE: Using "Target Type":creature_ai_script#TargetType 0 will cause the summoned creature to not attack anyone.
...
** Parameter 2: The "Target Type":creature_ai_script#TargetType defining whom the quest kill count should be given to. The value in this field needs to be a valid "Target Type":creature_ai_script#TargetType as specified in the reference tables below.
...
** Parameter 1: The field to change in the instance script. Again, this field needs to be a valid field that has been already defined in the instance's script.
** Parameter 2: The "Target Type":creature_ai_script#TargetType to use to get the GUID that will be stored at the field index. The value in this field needs to be a valid "Target Type":creature_ai_script#TargetType as specified in the reference tables below.
...
** Parameter 1: HP_Level
** Parameter 2: HP_Percent
...
All of the events, actions, and "Target Types":creature_ai_script#Target-Type are summarized in tabular format for convenience purposes and fast lookup. NU = Not Used; &#42; - optional
...
|11|ACTION_T_CAST|Spell ID|"Target Type":creature_ai_script#TargetType|Cast Flag|Casts spell on a target with specified cast flags (see table below).|
|12|ACTION_T_SPAWN|Creature ID|"Target Type":creature_ai_script#TargetType|Duration&#42;|Spawns a creature at itself for a given duration (infinite if zero, only with t_type != 0) that will attack a target.|
|13|ACTION_T_THREAT_SINGLE_PCT|Threat %|"Target Type":creature_ai_script#TargetType|NU|Modifies the target's threat by a percent|
|14|ACTION_T_THREAT_ALL_PCT|Threat %|NU|NU|Modifies everyone's threat by a percent|
|15|ACTION_T_QUEST_EVENT|Quest ID|"Target Type":creature_ai_script#TargetType|NU|Satisfies external script objective for a quest for the target (must be a player)|
|16|ACTION_T_CAST_EVENT|Quest ID|Spell ID|"Target Type":creature_ai_script#TargetType|Emulates spell cast on the creature for the target (must be a player) [hacky]|
|17|ACTION_T_SET_UNIT_FIELD|Field_Number|Value|"Target Type":creature_ai_script#TargetType|Sets unit field at the index to the value given for the target|
|18|ACTION_T_SET_UNIT_FLAG|Flag(s)|"Target Type":creature_ai_script#TargetType|NU|Sets flag(s) on the target|
|19|ACTION_T_REMOVE_UNIT_FLAG|Flag(s)|"Target Type":creature_ai_script#TargetType|NU|Removes flag(s) from the target|
...
|28|ACTION_T_REMOVEAURASFROMSPELL|"Target Type":creature_ai_script#TargetType|Spell ID|NU|Removes all auras from a spell ID from the target.|
...
|32|ACTION_T_SUMMON|Creature ID|"Target Type":creature_ai_script#TargetType|Summon ID|Summons a creature at the coords specified for the given summon id that will attack a target.|
|33|ACTION_T_KILLED_MONSTER|Creature ID|"Target Type":creature_ai_script#TargetType|NU|Simulates a kill for a mob of ID given for the player from the "Target Type":creature_ai_script#TargetType.|
|34|ACTION_T_SET_INST_DATA|Field|Value|NU|Sets new value for the field given in the instance script.|
|35|ACTION_T_SET_INST_DATA64|Field|"Target Type":creature_ai_script#TargetType|NU|Stores target's GUID at the field given in the instance script.|
...
|45|ACTION_T_THROW_AI_EVENT||||EventType, Radius, Target|
