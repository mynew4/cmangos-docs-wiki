...
Use this table to set up an infinite amount of texts or relay scripts to be randomized in the same action. Used in SCRIPT_COMMAND_TALK, SCRIPT_COMMAND_START_RELAY_SCRIPT and ACTION_T_START_RELAY_SCRIPT
...
If type = 0: The string entry from "dbscript_string.entry":Dbscript_string#entry
