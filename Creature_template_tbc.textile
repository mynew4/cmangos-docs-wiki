...
*NOT ALL FIELDS PORTED TO TBC, BE CAREFUL, IF IN DOUBT CHECK IN CODE (and edit here)*

h2. The `creature&#95;template` (2.4.3) table
...
|"HeroicEntry":Creature_template#heroic_entry|mediumint(8) unsigned|NO||0||
...
If not zero, this field refers to an entry of creature&#95;template. Which suppose to be used in heroic difficulty.
