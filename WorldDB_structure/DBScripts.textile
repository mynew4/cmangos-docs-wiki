...
For *creature&#95;movement&#95;scripts*, it is the "script id":Creature_movement#script_id of the waypoint.The PROPER formatting for the ID field is as follows: Creature&#95;ID + 2-Digit Script ID (Starting at 01). Example: c.2386 has few movement&#95;scripts, so 2386+01 = 238601 ... 23602 ..etc
...
|SCRIPT_FLAG_BUDDY_BY_GUID|0x10|Interpret "search_radius":DBScripts#search_radius as buddy's GUID.|
...
_Side note: Source or target must be player._
...
_Side note: Resulting source or target must be creature._

* *SCRIPT&#95;COMMAND&#95;XP&#95;USER = 33*
** datalong: Set experience gain to 1 = On or 0 = Off

_Side note: Source or target must be player. Only available on wotlk version._
