...
NOTE: When using a Negative value Wiki Say's it "REFERENCES" this means that you are Directing Core to look at REFERENCE_LOOT_TEMPLATE table to include that loot table.
