...
|1|Random Movement - Will Random Move inside SpawnDist Radius (Creature Table)|
|2|Waypoint Movement - Will Move Along Waypoint Path Defined In Creature_(Template)_Movement|
