...
|32|Trainer_Class|Allows the creature to have a class trainer list to teach spells. (TO BE USED ALSO WITH FLAG: 16)|
|64|Trainer_Profession|Allows the creature to have a profession trainer list to teach spells. (TO BE USED ALSO WITH FLAG: 16)|
|128|Vendor|Any creature selling items needs to have this flag.|
|256|Vendor_Ammo|Any creature selling ammo items needs to have this flag. (TO BE USED ALSO WITH FLAG: 128)|
|512|Vendor_Food|Any creature selling food items needs to have this flag. (TO BE USED ALSO WITH FLAG: 128)|
|1024|Vendor_Poison|Any creature selling poison items needs to have this flag. (TO BE USED ALSO WITH FLAG: 128)
|2048|Vendor_Reagent|Any creature selling reagent items needs to have this flag. (TO BE USED ALSO WITH FLAG: 128)|
