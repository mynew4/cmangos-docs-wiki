...
|"DifficultyEntry1":Creature_template#difficulty_entry|mediumint(8) unsigned|NO||0||
|"DifficultyEntry2":Creature_template#difficulty_entry|mediumint(8) unsigned|NO||0||
|"DifficultyEntry3":Creature_template#difficulty_entry|mediumint(8) unsigned|NO||0||
...
|"FactionAlliance":Creature_template#faction_a|smallint(5) unsigned|NO||0||
|"FactionHorde":Creature_template#faction_h|smallint(5) unsigned|NO||0||
|"Scale":Creature_template#scale|float|NO||0||
|"Family":Creature_template#family|tinyint(4)|YES||0||
|"CreatureType":Creature_template#type|tinyint(3) unsigned|NO||0||
|"InhabitType":Creature_template#inhabittype|tinyint(3) unsigned|NO||3||
|"RegenerateHealth":Creature_template#regenhealth|tinyint(3) unsigned|NO||1||
|"RacialLeader":Creature_template#racialleader|tinyint(3) unsigned|NO||0||
|"NpcFlags":Creature_template#npcflag|int(10) unsigned|NO||0||
|"UnitFlags":Creature_template#unit_flags|int(10) unsigned|NO||0||
|"DynamicFlags":Creature_template#dynamicflags|int(10) unsigned|NO||0||
|"ExtraFlags":Creature_template#flags_extra|int(10) unsigned|NO||0||
