...
|"entry/id":Creature_movement_(template)#id|int(10) unsigned|NO|PRI|0||
...
|"text1":Creature_movement_(template)#text|int(11)|NO||0|Obsolete, Do not use this Field|
|"text2":Creature_movement_(template)#text|int(11)|NO||0|Obsolete, Do not use this Field|
|"text3":Creature_movement_(template)#text|int(11)|NO||0|Obsolete, Do not use this Field|
|"text4":Creature_movement_(template)#text|int(11)|NO||0|Obsolete, Do not use this Field|
|"text5":Creature_movement_(template)#text|int(11)|NO||0|Obsolete, Do not use this Field|
|"emote":Creature_movement_(template)#emote|int(10) unsigned|YES||0|Obsolete, Do not use this Field|
|"spell":Creature_movement_(template)#spell|int(5) unsigned|YES||0|Obsolete, Do not use this Field|
|"orientation":Creature_movement_(template)#orientation|float|YES||0||
|"model1":Creature_movement_(template)#model1|int(11)|YES||0|Obsolete, Do not use this Field|
|"model2":Creature_movement_(template)#model2|int(11)|YES||0|Obsolete, Do not use this Field|
...
The GUID of the creature if creature_movement. See "creature.guid":creature#guid .
The entry of the creature if creature_movement_template. See "creature_template.entry":Creature_template#Entry .
