...
* Open the "sln" file that fits your version of Visual C++
  ...
  - mangosdVC150.sln for Visual Studio 2017
...
* You'll need to build ad, vmap_assembler, and vmap_extractor in a similar way you compiled CMaNGOS and ScriptDev2 (source code and VS solution files are in appropriately-named sub-folders of C:\Mangos\mangos\contrib), and copy the executable files (ad.exe, vmap_assembler.exe, and vmap_extractor.exe) created into your ++C:\World of Warcraft++ folder.
