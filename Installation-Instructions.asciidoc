...
- SQLyog (MySQL GUI Tool, for ease manage of your database: http://code.google.com/p/sqlyog/downloads/list[SQLyog]
...
SQLyog:
  allows you to connect to the MySQL server by providing an easy-to-use interface to import and change the data in the database (build to be user friendly, perfect for beginners )
