...
On Debian and Ubuntu you can simply install the ++libboost-all-dev++ meta-package. On Fedora there should be a package named ++boost-devel++ (untested).
...
[width="40%",cols=">s,^2m,^2e",frame="topbot",options="header"]
|======================
|         |Win32                         |x64
