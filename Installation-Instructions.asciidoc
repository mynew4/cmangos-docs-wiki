 ...
 * Cata-DB (UDB 4.3.4): http://udb.no-ip.org/index.php[forum, scroll down to UDB 4.3.4] | https://github.com/UDB-434/Database[git repository]
 ...
 * Visual C++ 2013 or newer: https://www.visualstudio.com/free-developer-offers/[Visual Studio Community] (Visual Studio Community 2015 is recommended).
...
Fill world database:
~~~~~~~~~~~~~~~~~~~~
*Support for Classic-DB & WOTLK-DB.*

From the C:\Mangos folder invoke (in Git bash or depending on installation with double-click!)

* ++cd classic-db++ OR ++cd wotlk-db++ (choose the one appliciaple to your situation)
* ++InstallFullUDB.sh++
+
...
MANGOS_DBNAME="mangos_wrath"

## Define your username
MANGOS_DBUSER="mangos_wrath"

## Define your password (It is suggested to restrict read access to this file!)
MANGOS_DBPASS="mangos_wrath"
...
CORE_PATH="C:\MangosWrath\mangos-wotlk"
...
*Support for TBC-DB.*
* Support for Windows:
* Go to C:/Mangos/tbc-db

Open Windows_Install_Script.bat in your prefered text-editor (notepad++ for instance) - don't run it!

At the top of the document you will see these lines;
...
SET RealmdDB="realmd"
-------------------------------
First, change ++SET CMangos="C:\CMangos"++ to ++SET CMangos="C:\Mangos"++
Secondly, you also wanna correct the ACID location to ++C:\Mangos\tbc-db\ACID++

Unless your changed any of the other settings while setting up the server you want to leave the rest on default.
