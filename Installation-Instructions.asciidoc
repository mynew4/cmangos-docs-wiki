...
- TBC-DB: http://udb.no-ip.org/index.php[forum, scroll down to TBC] | https://tbc-db.svn.sourceforge.net/svnroot/tbc-db[svn repository]
...
-----
Git::
  is a free distributed revision control or source code management tool which allows you to easily manage a virtual filesystem. With this tool, you'll download the code from CMaNGOS, ScriptDev2, and ACID (WoLtK).
...
This is considered optional, as ACID is usually included by the database providers (WoLtK).
...
- acid (containing the content of ACID for WoLtK, this is optional)
...
Fill ACID to world-database (WoLtK):
~~~~~~~~~~~~~~~~~~~~~~~~~~~~
