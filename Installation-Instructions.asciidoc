...
Update realmd.realmlist
~~~~~~~~~~~~~~~~~~~~~~~

You need to update your realmlist in the realmd database.
This is required so that the realmd "knows" to which mangosd he should forward a player after authentification

Apply this code to your realmd database:
---------------------
