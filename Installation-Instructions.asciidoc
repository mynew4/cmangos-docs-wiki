...
If you are using Visual Studio then http://cmangos.net/thread-7365.html provides an excellent step-by-step guide on how to set up boost for Visual Studio on Windows. Adjust the info in the guide to your version of VS and Windows, of course.
