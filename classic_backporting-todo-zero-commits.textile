bq. stfx: Tthere are some classic-only related commits but all others which dont exist on master but would theoretically fit there need to be added on master first (if proper) ;)
cala : commented some of the commits.

***

</code></pre>
* "zero":http://github.com/mangos-zero/server/commit/7746ed3 7746ed3 * Sidsukana (committer Sidsukana)<pre><code>[z1770] Fix spell Deep Wounds
  80.8% src/game/
  19.1% src/shared/
...
* "zero":http://github.com/mangos-zero/server/commit/5a5169b 5a5169b * Sidsukana (committer Sidsukana)<pre><code>[z1774] Fix speed modifiers for spells Permafrost, Improved Curse of Exhaustion, Camouflage, Pathfinding, Amplify Curse, Cheetah Sprint.
  95.8% src/game/
   4.1% src/shared/
...
* "zero":http://github.com/mangos-zero/server/commit/c653a66 c653a66 * Sidsukana (committer Sidsukana)<pre><code>[z1795] Fix take ammo for most ranged spells.
  97.4% src/game/
...
* "zero":http://github.com/mangos-zero/server/commit/4d68c37 4d68c37 * Salja (committer Salja)<pre><code>[z1798] Combustion (remove main aura) and (remove triggered aura stack) by Unlern Talents.
  91.2% src/game/
   8.7% src/shared/
...
* "zero":http://github.com/mangos-zero/server/commit/b7a8540 b7a8540 * Sidsukana (committer Sidsukana)<pre><code>[z1799] Remove extra mods code.
...
* "zero":http://github.com/mangos-zero/server/commit/139075f 139075f * TheLuda (committer TheLuda)<pre><code>[z1800] Remove all remains of TBC spell modifications.
  37.3% src/game/
  43.9% win/VC100/
  18.7% win/VC90/
...
* "zero":http://github.com/mangos-zero/server/commit/205862d 205862d * Salja (committer Sidsukana)<pre><code>[z1803] Fix Nightfall with changes. Thx Salja.
  88.3% src/game/
  11.6% src/shared/
...
* "zero":http://github.com/mangos-zero/server/commit/7962b72 7962b72 * Sidsukana (committer Sidsukana)<pre><code>[z1804] Fix CMSG_CHAT_IGNORED. Also fixed kick players if ignored player writing to them.
  66.8% src/game/
  33.1% src/shared/
...
* "zero":http://github.com/mangos-zero/server/commit/482ca12 482ca12 * Sidsukana (committer Sidsukana)<pre><code>[z1805] Fix Improved Sprint.
  76.2% src/game/
  23.7% src/shared/
...
* "zero":http://github.com/mangos-zero/server/commit/e0a0426 e0a0426 * Sidsukana (committer Sidsukana)<pre><code>[z1806] Fix HP change in bear forms.
  84.3% src/game/
  15.6% src/shared/
...
* "zero":http://github.com/mangos-zero/server/commit/84e3d1c 84e3d1c * Sidsukana (committer Sidsukana)<pre><code>[z1807] Fix spell 6346.
  51.2% sql/updates/
  18.4% sql/
  30.2% src/shared/
...
* "zero":http://github.com/mangos-zero/server/commit/b2d8643 b2d8643 * Sidsukana (committer Sidsukana)<pre><code>[z1809] Fix item 23197.
  27.7% sql/updates/
  18.0% sql/
  29.3% src/game/
  24.8% src/shared/
...
* "zero":http://github.com/mangos-zero/server/commit/621a2de 621a2de * Sidsukana (committer TheLuda)<pre><code>[z1824] Fix item 23197.
  40.2% sql/updates/
  23.9% sql/
  35.8% src/shared/
...
* "zero":http://github.com/mangos-zero/server/commit/f026561 f026561 * Cala Haryon (committer Cala Haryon)<pre><code>Modify the mana regeneration rate to be correct for 1.12 and below.
 100.0% src/game/
...
* "zero":http://github.com/mangos-zero/server/commit/c041d59 c041d59 * Cala Haryon (committer Cala Haryon)<pre><code>Fix glancing blows formula for zero.
 100.0% src/game/

bq. [OK] cala : this one is ok. See * "Glancing blow":http://www.wowwiki.com/Glancing_blow *

</code></pre>
* "zero":http://github.com/mangos-zero/server/commit/06f5bb3 06f5bb3 * Cala Haryon (committer Cala Haryon)<pre><code>Fix Druid Enrage Armor. Thanks to Salja
 100.0% src/game/
...
* "zero":http://github.com/mangos-zero/server/commit/6cffeff 6cffeff * Cala Haryon (committer Cala Haryon)<pre><code>Fix Sheeped/Feared Targets Bugging. Thanks Zataron & Salja
 100.0% src/game/
...
* "zero":http://github.com/mangos-zero/server/commit/65baeed 65baeed * Cala Haryon (committer Cala Haryon)<pre><code>Lower Stealth Detection of Creatures. Thanks Zataron & Salja
 100.0% src/game/
...
* "zero":http://github.com/mangos-zero/server/commit/22d7054 22d7054 * Cala Haryon (committer Cala Haryon)<pre><code>Fix Aggro issues of Npc Summons. Thanks Zataron & Salja
 100.0% src/game/
...
* "zero":http://github.com/mangos-zero/server/commit/f7debc1 f7debc1 * Cala Haryon (committer Cala Haryon)<pre><code>Fix Druid Attackpower in Cat and Bear Form. Patch by Zataron & Salja
 100.0% src/game/
...
* "zero":http://github.com/mangos-zero/server/commit/e45f908 e45f908 * Cala Haryon (committer Cala Haryon)<pre><code>Fix Beastslayer Damage Bonus. Thanks Zataron & Salja
 100.0% src/game/
...
FILE LAST UPDATED BASED ON... "zero":http://github.com/mangos-zero/server/commit/9293a6d 9293a6d * TheLuda (committer TheLuda)