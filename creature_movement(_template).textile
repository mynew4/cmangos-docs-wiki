...
|"guid/entry":creature_movement(_template)#guid/entry|int(10) unsigned|NO|PRI|0||
|"pathId":creature_movement(_template)#pathId|int(11) unsigned|NO|PRI|0|CURRENTLY TEMPLATE ONLY|
