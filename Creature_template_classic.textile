...
*NOT ALL FIELDS PORTED TO CLASSIC, BE CAREFUL, IF IN DOUBT CHECK IN CODE (and edit here)*

h2. The `creature&#95;template` (1.12.x) table
...
|"Civilian":civilian (TODO)|uint32|NO|0||
...
|0x00000004|UNIT_NPC_FLAG_VENDOR||
|0x00000008|UNIT_NPC_FLAG_FLIGHTMASTER||
|0x00000010|UNIT_NPC_FLAG_TRAINER||
|0x00000020|UNIT_NPC_FLAG_SPIRITHEALER||
|0x00000040|UNIT_NPC_FLAG_SPIRITGUIDE||
|0x00000080|UNIT_NPC_FLAG_INNKEEPER||
|0x00000100|UNIT_NPC_FLAG_BANKER||
|0x00000200|UNIT_NPC_FLAG_PETITIONER||
|0x00000400|UNIT_NPC_FLAG_TABARDDESIGNER||
|0x00000800|UNIT_NPC_FLAG_BATTLEMASTER||
|0x00001000|UNIT_NPC_FLAG_AUCTIONEER||
|0x00002000|UNIT_NPC_FLAG_STABLEMASTER||
|0x00004000|UNIT_NPC_FLAG_REPAIR||
|0x20000000|UNIT_NPC_FLAG_OUTDOORPVP|custom flag for outdoor pvp creatures|
